...
export const getAllDoctors = catchAssyncErrors(async(req,res,next)=>{
...
export const logoutAdmin = catchAssyncErrors(async(req,res,next)=>{
...
export const logoutPatient = catchAssyncErrors(async(req,res,next)=>{
